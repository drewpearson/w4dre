...
<html lang="en">
  ...
  <body>
        ...
        <div class="row g-5">
          ...
          <div class="col-md-6">
            ...
            <ul class="icon-list ps-0">
              ...
              <li class="d-flex align-items-start mb-1"><a href="https://dxheat.com/dxc/" target="_blank">DX Heat</a></li>
    ...
    <cfset json_links = fileRead('#ExpandPath( "/")#links.json')>
    <pre><cfoutput>#json_links#</cfoutput></pre>
